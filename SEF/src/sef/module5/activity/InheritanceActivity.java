...
public class InheritanceActivity {
	...
	public static void main(String[] args) {
		...
		System.out.println("-----------------------------");
		System.out.println("Employee's Name is   : " + p.getName());
		System.out.println("Employee's Age is    : " + p.getAge());
		...
		System.out.println("-----------------------------");
		System.out.println("Person's Name is    : " + e.getName());
		System.out.println("Person's Age is     : " + e.getAge());
