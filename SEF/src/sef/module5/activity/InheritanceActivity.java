...
//        Person_I p = new Person_I("Sarah Johnson", 21); // <- better way to create Person_I
...
//        Employee_I e = new Employee_I("Shawn Cun", 32, 70000, "Developer"); // <- better way to create Employee
