...
public class TryCatchFinallySample {
	...
	public void catchMeIfYouCan()
	{
		...
		//You should program in a way that such issues are captured. Follow the instructions given by
		// your trainer to complete this code with try, catch, finally blocks
